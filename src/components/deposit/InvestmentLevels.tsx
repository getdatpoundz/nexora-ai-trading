...
const LEVELS: Level[] = [
  ...
  { key: "PLUS",         name: "Plus",          amount: 10000,   description: "För dig som vill skapa en större marknadsexponering och följa utvecklingen långsiktigt.", maxTradesPerMonth: 60,  maxLeveragePct: 0 },
  { key: "ADVANCED",     name: "Advanced",      amount: 25000,   description: "En högre investeringsnivå som kräver god förståelse för kryptomarknadens risker.", maxTradesPerMonth: 100, maxLeveragePct: 0, popular: true },
  { key: "PREMIUM",      name: "Premium",       amount: 50000,   description: "För erfarna användare som accepterar betydande värdeförändringar och kapitalrisk.", maxTradesPerMonth: 150, maxLeveragePct: 0 },
  { key: "PRIVATE",      name: "Private",       amount: 100000,  description: "En större kapitalplacering med utökad kontroll av investerarens profil och pengarnas ursprung.", maxTradesPerMonth: 200, maxLeveragePct: 0 },
  { key: "PRIVATE_PLUS", name: "Private Plus",  amount: 250000,  description: "För större kapitalplaceringar som kräver kompletterad kundkännedom före aktivering.", maxTradesPerMonth: 300, maxLeveragePct: 0 },
  { key: "WEALTH",       name: "Wealth",        amount: 500000,  description: "En avancerad nivå där personlig kontakt och utökad verifiering krävs innan insättning.", maxTradesPerMonth: 500, maxLeveragePct: 0 },
  { key: "WEALTH_ONE",   name: "Wealth One",    amount: 1000000, description: "Den högsta nivån. Kräver individuell granskning, dokumentation och godkännande innan insättning.", maxTradesPerMonth: 1000, maxLeveragePct: 0 },
];
